document.addEventListener('DOMContentLoaded', function() {
    ...
    const chooseDeviceOptions = document.getElementById('chooseDeviceOptions');
    ...
    document.addEventListener('click', function(event) {
        if (!chooseDeviceBtn.contains(event.target) && !chooseDeviceOptions.contains(event.target)) {
            chooseDeviceOptions.style.display = 'none';
        }
        if (!shareBtn.contains(event.target) && !shareOptions.contains(event.target)) {
            shareOptions.style.display = 'none';
        }
        if (!queueBtn.contains(event.target) && !queueOptions.contains(event.target)) {
